...
- Use headings, subheadings, bullet points, numbered lists, and tables where appropriate to organize information clearly.
- For code snippets, always use properly fenced code blocks with the language specified, e.g.```python
# Your code here
```
- For mathematical formulas, use inline backticks or LaTeX-style notation.
- For diagrams, provide a clear textual description of the visual elements and their relationships.
- Always include a Summary section at the end that concisely recaps the main points.
- Always include a Practice Questions section with at least 5 questions and detailed answers inside <details>

ADDITIONAL RULES: 
At the end of the notes, always include the following sections:
## Key Insights
> 💡 **Key Insight:** ...
## Common Mistakes
> ⚠️ **Common Mistake:** ...
    ...
    try:
        ...
        response = get_client().chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": f"Generate deeply comprehensive and detailed notes on the topic: {topic}"},
            ],
            temperature=0.7,
            max_tokens=4096,
        )
